...
export default function HomePage() {
  ...
  useLayoutEffect(() => {
    ...
    let ctx = gsap.context(() => {
      // A Timeline do Webflow traduzida para o seu layout
      ...
      // Animação Sequencial dos 2 Textos
  ...
  return (
    <main className="bg-[#0f1015] text-white flex flex-col items-center relative font-sora select-none overflow-x-hidden">
      ...
      {/* 2. SEÇÃO SOBRE - O PIN IGUAL AO WEBFLOW COM OS 2 TEXTOS */}
      <section ref={containerRef} id="sobre" className="w-full bg-[#0f1015] relative z-20 border-t border-zinc-900/50">
        <div className="h-screen w-full flex items-center justify-center px-6 relative overflow-hidden">
          ...
          <div ref={text1Ref} className="max-w-4xl absolute text-center opacity-0 pointer-events-none">
          ...
          <div ref={text2Ref} className="max-w-4xl absolute text-center opacity-0 pointer-events-none">
      ...
      {/* 3. SEÇÃO SERVIÇOS - RESTAURADA COM FIBRA ÓTICA */}
      <section id="servicos" className="py-20 w-full max-w-7xl mx-auto px-6 relative z-30 flex flex-col items-center border-t border-zinc-900/30">
          ...
          {[1, 2, 3].map((n) => (
            <div key={n} className="relative group rounded-[32px] overflow-hidden aspect-video shadow-2xl border border-zinc-800">
              ...
              <Image 
                ...
                alt="Serviço" fill className="object-cover opacity-40" 
              />
